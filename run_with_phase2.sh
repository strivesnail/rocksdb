...
# Phase2=1 时必须同时设置：0=level-base，1=hash-base，2|no-fdp，3|native|native-base（未设置或非法值会失败）
...
echo "ROCKSDB_HASH_HANDLE: ${ROCKSDB_HASH_HANDLE} (0=level-base, 1=hash-base, 2=no-fdp, 3=native-base)"
